...
namespace project
{
    public partial class clientadmin : Form
    {
        ...
        MySqlConnection connection = new MySqlConnection("server=localhost;database=hotel_db;uid=root;pwd=rootroot");
          ...
          try
           {
             ...
             {
                  MessageBox.Show("you cann't update this gust becouse it booking Room ");
                 connection.Close();
            }
            catch (Exception ex)
            {
        ...
        private void dataGridViewforgust_CellEnter_1(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void fristname_KeyPress_1(object sender, KeyPressEventArgs e)
        {
        ...
        private void passport_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            // allows only numbers
            if (!char.IsNumber(e.KeyChar))
        ...
        private void city_KeyPress_1(object sender, KeyPressEventArgs e)
        {
