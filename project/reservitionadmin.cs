...
namespace project
{
    public partial class reservitionadmin : Form
    {
        MySqlConnection con = new MySqlConnection("server=localhost;database=hotel_db;uid=root;pwd=rootroot");
        ...
        private void reservitionadmin_Load(object sender, EventArgs e)
        {
            reservupdate();
            refreshdatagrid();
        }
