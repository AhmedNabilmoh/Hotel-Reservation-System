...
delimiter *
create function ad_deleted_gust(Gust_ID double,first_name varchar(256),last_name varchar(256),Gender varchar(256),passport double,city varchar(256),Phone_Number double,birthday date)
returns int 
begin
insert into Deleted_GUST values(Gust_ID,first_name,last_name,Gender,passport,city,Phone_Number,birthday);   
return 1;
end *
delimiter ;
